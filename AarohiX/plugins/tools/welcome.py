...
def welcomepic(pic, user, chatname, id, uname):
    background = Image.open("AarohiX/assets/annie/AnnieNwel.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp)
    pfp = pfp.resize((823, 821))
    draw = ImageDraw.Draw(background)
    font_large = ImageFont.truetype('AarohiX/assets/annie/ArialReg.ttf', size=65)
    font_small = ImageFont.truetype('AarohiX/assets/annie/ArialReg.ttf', size=60)
